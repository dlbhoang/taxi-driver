...
class _HomePageState extends State<HomePage>
{
  ...
  String titleToShow = "TRỰC TUYẾN NGAY";
                            ...
                            child: Padding(
                              ...
                              child: Column(
                                children: [
                                  ...
                                  Text(
                                      (!isDriverAvailable) ? "TRỰC TUYẾN NGAY" : "TẠM NGHỈ NGAY",
                                  ...
                                  Text(
                                    (!isDriverAvailable)
                                        ? "Bạn chuẩn bị lên mạng, bạn sẽ sẵn sàng nhận yêu cầu chuyến đi từ người dùng."
                                        : "Bạn sắp ngoại tuyến, bạn sẽ ngừng nhận yêu cầu chuyến đi mới từ người dùng.",
                                    textAlign: TextAlign.center,
                                    style: const TextStyle(
                                          ...
                                          onPressed: ()
                                          {
                                            ...
                                            else
                                            {
                                              ...
                                              setState(() {
                                                ...
                                                titleToShow = "Trực tuyến ngay";
                                                isDriverAvailable = false;
                                              });
                                            }
                                          },
                                          style: ElevatedButton.styleFrom(
                                            backgroundColor: (titleToShow == "Trực tuyến ngay")
                                                ? Colors.green
                                                : Colors.pink,
                                          ),
                                          child: const Text(
