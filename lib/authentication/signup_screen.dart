...
class _SignUpScreenState extends State<SignUpScreen>
{
  ...
  checkIfNetworkIsAvailable()
  {
    ...
    {
      cMethods.displaySnackBar("Vui lòng chọn hình ảnh đầu tiên.", context);
    }
  }
  ...
  signUpFormValidation()
  {
    ...
    {
      cMethods.displaySnackBar("tên của bạn phải có ít nhất 4 ký tự trở lên.", context);
    }
    else if(userPhoneTextEditingController.text.trim().length < 7)
    {
      cMethods.displaySnackBar("số điện thoại của bạn phải có ít nhất 8 ký tự trở lên.", context);
    }
    ...
    {
      cMethods.displaySnackBar("vui lòng viết mẫu xe của bạn", context);
    }
    else if(vehicleColorTextEditingController.text.trim().isEmpty)
    {
      cMethods.displaySnackBar("xin vui lòng viết màu xe của bạn.", context);
    }
    else if(vehicleNumberTextEditingController.text.isEmpty)
    {
      cMethods.displaySnackBar("xin vui lòng viết số xe của bạn.", context);
    }
    else
    {
